...
> [!NOTE]
> If you're not running a local searxng instance or don't care about MCP alignment, the upstream version at [gsd-build/get-shit-done](https://github.com/gsd-build/get-shit-done) is the better choice.

The documentation below is from upstream and covers commands and concepts shared by both forks, but the installation methods described in the upstream README do not apply here.
